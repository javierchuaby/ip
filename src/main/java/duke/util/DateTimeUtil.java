 ...
 * Handles both date-only and date-time parsing with flexible format support.
 */
public final class DateTimeUtil {
    ...
    /**
     * Parses a date/time string using multiple format patterns.
     * Tries date-time patterns first, then date-only patterns.
     *
