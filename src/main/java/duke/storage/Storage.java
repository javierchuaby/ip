...
public class Storage {
  ...
  public void save(List<Task> tasks) {
    ...
    try {
      Files.move(
          tmp, dataFile, StandardCopyOption.REPLACE_EXISTING, StandardCopyOption.ATOMIC_MOVE);
    } catch (IOException ioe) {
      try {
      ...
      case "E":
        {
          ...
          if (fromRaw.contains("T")) {
            ...
            from =
                LocalDate.parse(fromRaw, DateTimeFormatter.ofPattern("yyyy-MM-dd")).atStartOfDay();
            fromHasTime = false;
          }
